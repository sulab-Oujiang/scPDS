...
#              Hyperparameters               #
##############################################
Drug = "Osimertinib".upper()

# File Path
Bulk_label_path = "Data/Cell_Line_Label.csv"
Bulk_data_path = "Data/Cell_Line_Pathway_Active_Score.csv"
Sc_data_path = "Data/LUAD/Pathway_Active_Score.csv"

# Transformer
T_sample = "NOsampling"                        # sampling strategy: NOsampling, DOWNsampling, UPsampling, SMOTEsampling.
...
T_embedding_dim = 1324                         # embedded dimension
...
P_dropout = 0.2                                # dropout of Predictor
